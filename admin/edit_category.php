<?php
    ...
    if(isset($_POST['update_category'])){
        ...
        if(empty($category_title)){
            echo "<script>showToast('Please fill the field', 'error');</script>";
        }else{
            // update query 
            ...
            if($update_category_result){
                echo "<script>showToast('Category updated successfully', 'success'); setTimeout(() => { window.location.href = './index.php?view_categories'; }, 2000);</script>";
            }
        }
    }
    ?>
